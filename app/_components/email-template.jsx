		...
		<Body style={main}>
			<Container style={container}>
				...
				<Text style={paragraph}>
					Thank you purchasing on Easy Learn marketplace. Click on Below download button to download the all digital content
				</Text>
				<Section style={btnContainer}>
					<Button pX={12} pY={12}
						...
						href='https://res.cloudinary.com/dtcfyow8s/image/upload/v1712461934/go_5a72a9961f.jpg'>
						Download
					</Button>
				</Section>
				<Text style={paragraph}>
